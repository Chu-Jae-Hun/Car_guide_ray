...
public class CalendarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText textInput = v.findViewById(R.id.textInput);
        View dayContent = v.findViewById(R.id.dayContent);
        ...
        Button saveTextButton = v.findViewById(R.id.saveTextButton);
        ...
        Button todayButton = v.findViewById(R.id.todayButton);
    ...
    private void saveInfo(){
        File file = new File(getActivity().getFilesDir(), "saved");
        File daysFile = new File(getActivity().getFilesDir(), "days");
        File monthsFile = new File(getActivity().getFilesDir(), "months");
        File yearsFile = new File(getActivity().getFilesDir(), "years");
